  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={cn(
          "h-screen fixed left-0 top-0 z-50 flex-col border-r border-border/40 bg-background shadow-sm transition-all duration-300",
      ...
      >
        ...
        {/* === Quick Action Button === */}
        <div className={`p-4 border-t border-border/30 w-full overflow-hidden ${isMobile && !mobileOpen ? 'hidden' : ''}`}>
          <Button
            asChild
        ...
        {/* === User Section === */}
        <div className={`p-4 border-t border-border/30 w-full ${isMobile && !mobileOpen ? 'hidden' : ''}`}>
          <DropdownMenu>
